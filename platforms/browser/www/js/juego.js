var app = {
  ...
  iniciaJuego: function() {
    ...
    function update() {
	  ...
	  if ((bola.body.blocked.up)||(bola.body.blocked.down)||(bola.body.blocked.right)||(bola.body.blocked.left)){
		this.stage.backgroundColor = "#FF0000";  
	  }else{
		//color = "#f27d0c";
		//color = "rgb(242,125,12)";
		green = 125 + 2*dificultad;
		if (green>255){
			green = 255;
		}
		color = "rgb(242,"+green+",12)";
